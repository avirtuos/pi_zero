...
class Bme280Sensor:
  ...
  bus = smbus.SMBus(1) # Rev 2 Pi, Pi 2 & Pi 3 & Zero uses bus 1
                       # Rev 1 Pi uses bus 0
  ...
  def readBME280All(self, addr=DEVICE):
    # This method - and all the code used to communicate with the BME280 over i2c comes courtesy of the below author:
    #
    # Author : Matt Hawkins
    # Date   : 25/07/2016
    #
